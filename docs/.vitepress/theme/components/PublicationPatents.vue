...
year={2015},
        ...
        <el-card shadow="hover">
            <p>1.许灿辉, 汤帜, 陶欣, 史操. 版式文档中复合图的逻辑处理装置和逻辑处理方法，CN104142961A</p>
        ...
        <el-card shadow="hover">
            <p>2.许灿辉, 汤帜, 陶欣, 史操. 版式文档中复合图的提取装置和提取方法，CN104346615A</p>
        ...
        <el-card shadow="hover">
            <p>3.许灿辉, 汤帜, 徐剑波, 陶欣.一种列表识别方法与系统，CN104517106A</p>
        ...
        <el-card shadow="hover">
            <p>4.许灿辉, 汤帜, 徐剑波, 陶欣.一种表格识别方法与系统，CN104517112A</p>
        ...
        <el-card shadow="hover">
            <p>5.桂卫华，阳春华，周开军，许灿辉. 一种浮选泡沫图像视觉监控装置，CN101404722A</p>
        ...
        <el-card shadow="hover">
            <p>6.桂卫华，阳春华，周开军，许灿辉. 用于浮选泡沫图像分析的关键特征提取方法，CN101334844A</p>
        ...
        <el-card shadow="hover">
            <p>7.Canhui Xu, Zhi Tang, Jianbo Xu, Xin Tao.TABLE RECOGNIZING METHOD AND TABLE RECOGNIZING
        ...
        <el-card shadow="hover">
            <p>8.Canhui Xu, Zhi Tang, Jianbo Xu, Xin Tao. List recognizing method and list recognizing
